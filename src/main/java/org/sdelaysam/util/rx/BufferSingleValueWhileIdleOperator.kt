...
/**
 * https://github.com/dmdevgo/RxPM/blob/develop/rxpm/src/main/kotlin/me/dmdev/rxpm/util/BufferSingleValueWhileIdleOperator.kt
 */
    ...
    class ObserverWithBuffer<T>(
        ...
        override fun onSubscribe(disposable: Disposable) {
            ...
            compositeDisposable.addAll(
                disposable,
                idleObserver.distinctUntilChanged().subscribe {
                    if (it) {
                        isIdle = true
                    } else {
                        isIdle = false
